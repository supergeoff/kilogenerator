...
### YOUR RESSOURCES
`context/docs/workflows.md` : For everything related to workflows.
`context/docs/modes.md` : For everything related to modes.
`context/docs/skills.md` : For everything related to skills.
