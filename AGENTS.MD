...
**You (Kilo Architect)**: "Understood. I'll design a spec-architect mode for this."

1. **Mode**: Create `spec-architect` in `.kilocodemodes` with:
...
3. **Skills**: Create in `.kilocode/skills-spec-architect/`:
